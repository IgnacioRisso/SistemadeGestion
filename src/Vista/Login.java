...
login lg = new login();
    ...
    public void validar (){
        ...
        if (!"" .equals(correo) || !"" .equals(pass)){
            ...
            if (lg.getCorreo()!= null && lg.getPass()!= null){
                ...
                JOptionPane.showMessageDialog(null, "La contraseña o el correo son incorrectos");
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 320, 400));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 220, 430));
